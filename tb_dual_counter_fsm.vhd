...
architecture Behavior of tb_dual_counter_fsm is 
    ...
    signal up_A : std_logic := '1'; -- A 上數
    signal up_B : std_logic := '0'; -- B 下數
    signal low_A : std_logic_vector(3 downto 0) := "0000";  -- 1
    signal high_A : std_logic_vector(3 downto 0) := "0111"; -- 4
    signal low_B : std_logic_vector(3 downto 0) := "1000";  -- 5
